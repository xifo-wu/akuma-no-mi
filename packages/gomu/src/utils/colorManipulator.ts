...
// 根据背景色展示文字颜色
export const getContrastText = (background: string, lightColor: string, darkColor: string) => {
  const contrastThreshold = 3;

  return getContrastRatio(background, darkColor) >= contrastThreshold ? darkColor : lightColor;
};
